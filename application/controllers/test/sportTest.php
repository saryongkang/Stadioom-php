...
//            remove_ssl();
    ...
    public function beforeClass() {
        ...
        // add sport 1, 2, 3.
        $result = $this->sendPost($this->config->item('base_url') . "api/sport", array('accessToken' => $this->accessToken, 'name' => 'sport_1', 'stringId' => 'sport_1', 'desc' => 'Sport for testing_1 with higher priority', 'priority' => 100, 'firstRevision' => 1, 'latestRevision' => 1, 'updateFlag' => '1'));
        $this->sportId1 = json_decode($result);
        $result = $this->sendPost($this->config->item('base_url') . "api/sport", array('accessToken' => $this->accessToken, 'name' => 'sport_2', 'stringId' => 'sport_2', 'desc' => 'Sport for testing_2 with lower priority', 'priority' => 1, 'firstRevision' => 1, 'latestRevision' => 2, 'updateFlag' => '2'));
        $this->sportId2 = json_decode($result);
        $result = $this->sendPost($this->config->item('base_url') . "api/sport", array('accessToken' => $this->accessToken, 'name' => 'sport_3', 'stringId' => 'sport_3', 'desc' => 'Sport for testing_3 with mid priority', 'priority' => 50, 'firstRevision' => 1, 'latestRevision' => 2, 'updateFlag' => '2'));
        $this->sportId3 = json_decode($result);
        
        // add brand 1, 2, 3.
        $result = $this->sendPost($this->config->item('base_url') . "api/brand", array('accessToken' => $this->accessToken, 'name' => 'brand_1', 'stringId' => 'brand_1', 'desc' => 'Brand for testing_1 with higher priority', 'priority' => 100, 'firstRevision' => 1, 'latestRevision' => 1, 'updateFlag' => '1'));
        $this->brandId1 = json_decode($result);
        $result = $this->sendPost($this->config->item('base_url') . "api/brand", array('accessToken' => $this->accessToken, 'name' => 'brand_2', 'stringId' => 'brand_2', 'desc' => 'Brand for testing_2 with lower priority', 'priority' => 1, 'firstRevision' => 1, 'latestRevision' => 2, 'updateFlag' => '2'));
        $this->brandId2 = json_decode($result);
        $result = $this->sendPost($this->config->item('base_url') . "api/brand", array('accessToken' => $this->accessToken, 'name' => 'brand_3', 'stringId' => 'brand_3', 'desc' => 'Brand for testing_2 with mid priority', 'priority' => 50, 'firstRevision' => 1, 'latestRevision' => 2, 'updateFlag' => '2'));
...
//        Assert::assertInData($result, 2, 'id', $this->sportId2);
    ...
    public function testGetSponsorBrands() {
        ...
        $result = $this->runTest("get brands sponsoring sport " . $this->sportId1, "api/sport/brands", array('accessToken' => $this->accessToken, 'id' => $this->sportId1), 'GET');
        ...
        $result = $this->runTest("get brands sponsoring sport " . $this->sportId2, "api/sport/brands", array('accessToken' => $this->accessToken, 'id' => $this->sportId2), 'GET');
        Assert::assertArrayCount($result, 1);
        Assert::assertContainsInData($result, 'id', $this->brandId2);

        // get brands sponsoring sport 3.
        $result = $this->runTest("get brands sponsoring sport " . $this->sportId3, "api/sport/brands", array('accessToken' => $this->accessToken, 'id' => $this->sportId3), 'GET');
