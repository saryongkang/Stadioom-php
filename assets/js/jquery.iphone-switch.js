...
jQuery.fn.iphoneSwitch = function(start_state, switched_on_callback, switched_off_callback, options) {
	...
	var imagesfolder = '/assets/images/onoffswitch/';
	// define default settings
	var settings = {
		mouse_over: 'pointer',
		mouse_out:  'default',
		switch_on_container_path: imagesfolder+'iphone_switch_container_on.png',
		switch_off_container_path: imagesfolder+'iphone_switch_container_off.png',
		switch_path: imagesfolder+'iphone_switch.png',
		switch_height: 27,
		switch_width: 94
	};
